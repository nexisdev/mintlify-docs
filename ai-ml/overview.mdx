...
description: 'Comprehensive guide to Nexis Appchain AI/ML capabilities, proof-of-inference, and agent coordination'
icon: 'brain-circuit'
---

## Introduction to Nexis AI Infrastructure

Nexis Appchain provides a comprehensive Layer-2 infrastructure for decentralized AI and machine learning operations. Built on the OP Stack, Nexis enables verifiable AI inference, agent coordination, and trustless task execution with economic security guarantees.

<CardGroup cols={2}>
  <Card title="Proof-of-Inference" icon="shield-check" href="/ai-ml/proof-of-inference">
    Cryptographic verification of AI model outputs with on-chain commitments
  </Card>
  <Card title="AI Agents" icon="robot" href="/ai-ml/ai-agents">
    Decentralized agent registry with staking, reputation, and delegation
  </Card>
  <Card title="LangGraph Integration" icon="diagram-project" href="/ai-ml/langgraph">
    Event-driven workflows and state machine orchestration
  </Card>
