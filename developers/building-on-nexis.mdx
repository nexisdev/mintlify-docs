---
title: 'Build AI Blockchain dApps on Nexis | Web3 AI Development'
...
module.exports = {
  ...
  networks: {
    ...
    nexisMainnet: {
      url: process.env.NEXIS_MAINNET_RPC || "https://rpc.nexis.network",
...
[rpc_endpoints]
nexis_testnet = "https://rpc.testnet.nexis.network"
nexis_mainnet = "https://rpc.nexis.network"
...
export const nexisTestnet = defineChain({
  ...
  rpcUrls: {
    default: {
      http: ['https://rpc.testnet.nexis.network'],
  ...
  blockExplorers: {
    default: {
      name: 'Nexis Explorer',
      url: 'https://explorer.testnet.nexis.network',
    },
  },
  contracts: {
    agents: {
...
<Note>
Need help? Join our [Developer Discord](https://discord.gg/nexis) or check [GitHub Discussions](https://github.com/nexis-network/nexis-base-appchain/discussions) for community support.
</Note>