...
export const config = createConfig({
  chains: [nexisTestnet],
  transports: {
    [nexisTestnet.id]: http('https://rpc.testnet.nexis.network')
  }
});
...
export const nexisTestnet = {
  ...
  rpcUrls: {
    default: { http: ['https://rpc.testnet.nexis.network'] }
  },
  blockExplorers: {
    default: { name: 'Nexis Explorer', url: 'https://explorer.testnet.nexis.network' }
  }
};
...
npx hardhat node --fork https://rpc.testnet.nexis.network
...
```bash
# Get testnet tokens
# Visit: https://faucet.nexis.network
...
<Note>
**Need help?** Join our [Developer Discord](https://discord.gg/nexis) or check [GitHub Discussions](https://github.com/nexis-network/nexis-base-appchain/discussions).
</Note>