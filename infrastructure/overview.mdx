...
op-geth \
  ...
  --rollup.sequencerhttp=https://sequencer.nexis.network \
...
graph TB
    subgraph "Public Infrastructure"
        SEQ[Sequencer Node<br/>sequencer.nexis.network]
        RPC1[RPC Node 1<br/>rpc.nexis.network]
        RPC2[RPC Node 2<br/>rpc2.nexis.network]
