...
const wsProvider = new ethers.WebSocketProvider('wss://ws.testnet.nexis.network');
...
```bash
# Clone repo
git clone https://github.com/nexis-network/nexis-base-appchain
...
curl https://rpc.testnet.nexis.network/health
