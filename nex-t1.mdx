---
title: 'Nex‑T1 AI Agents & Orchestration'
description: 'Production‑ready FastAPI + LangGraph multi‑agent system with MCP integrations for research, trading, and risk evaluation.'
icon: 'sparkles'
---
