...
<Card title="Emission Analytics" icon="chart-line" href="https://analytics.nexis.network/emissions">
...
<CardGroup cols={2}>
  ...
  <Card title="Analytics Dashboard" icon="chart-line" href="https://analytics.nexis.network">
...
<Note>
**Transparency**: All emission data is on-chain and publicly verifiable. View the MintManager contract on [Block Explorer](https://explorer.nexis.network) for real-time tracking.
</Note>