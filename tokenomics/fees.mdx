...
<Card title="Fee Analytics Dashboard" icon="chart-line" href="https://analytics.nexis.network/fees">
...
<CardGroup cols={2}>
  ...
  <Card title="Fee Analytics" icon="chart-line" href="https://analytics.nexis.network/fees">
