...
- **Governance Portal**: [Vote on proposals](https://gov.nexis.network)
- **Staking Dashboard**: [Stake NZT](https://stake.nexis.network)
- **Analytics**: [Token metrics](https://analytics.nexis.network)

---

<Note>
**Need Help?** Join our [Discord community](https://discord.gg/nexis) or visit our [documentation](https://docs.nexis.network) for technical questions.
</Note>
