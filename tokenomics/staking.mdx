...
<Steps>
  ...
  <Step title="Connect Wallet">
    Connect to [stake.nexis.network](https://nex-t1.ai)
  </Step>
...
<Card title="Staking Dashboard" icon="chart-line" href="https://nex-t1.ai/dashboard">
...
<CardGroup cols={2}>
  <Card title="Stake NZT" icon="lock" href="https://nex-t1.ai">
