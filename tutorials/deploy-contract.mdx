...
description: 'Complete guide to deploying and verifying smart contracts on Nexis Appchain using Hardhat and Foundry'
---
...
<CardGroup cols={2}>
  ...
  <Card title="Testnet NZT" icon="coins">
    Get tokens from the [faucet](/tutorials/use-faucet)
  </Card>
...
- [Nexis GitHub Examples](https://github.com/nexis-network/nexis-base-appchain/tree/main/examples)
